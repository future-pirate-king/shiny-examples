...
app = dash.Dash(__name__, update_title=None, external_stylesheets=external_stylesheets, url_base_pathname=os.environ["BASE_URL"])
server = app.server
...
if __name__ == "__main__":
    app.run_server(host=os.environ["HOST"], debug=True, port=os.environ["PORT"], dev_tools_props_check=False)
